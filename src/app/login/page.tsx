                        ...
                        <div>
                            ...
                            <div className="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-10 pr-3 py-2.5 border border-slate-800 rounded-xl bg-slate-950 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm"
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                type="button"
                                className="w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-slate-800 rounded-xl shadow-sm bg-slate-950 text-sm font-medium text-slate-300 hover:bg-slate-800/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-all"
                            >
